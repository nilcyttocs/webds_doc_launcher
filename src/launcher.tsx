  ...
  protected render(): React.ReactElement<any> | null {
    ...
    docItems.forEach((item) => {
      ...
      const card = (
        <div className="jp-NewLauncher-item" onClick={mainOnClick}>
          ...
          <div
            className="jp-NewLauncher-label jp-NewLauncher-Cell"
            title={label}
          >
            {label}
          </div>
    ...
    const content: React.ReactElement<any> = (
      <div className="jp-NewLauncher-section" key={"webds_doc_launcher"}>
        ...
        <div className="jp-NewLauncher-cardContainer">{cards}</div>
      </div>
    );
...
namespace Private {
  export function sortCmp(a: any, b: any, commands: CommandRegistry): number {
    const r1 = a.rank;
    const r2 = b.rank;
